...
def idx_demo(env, one_feature):
    ...
    raw_demo = np.load(file=f"{BASE_PATH}/expert_demo/expert_demo.npy")
...
def main():
    ...
    for episode in range(30000):
        ...
        if episode % 1000 == 0:
            ...
            pylab.savefig(f"{BASE_PATH}/learning_curves/maxent_30000.png")
            np.save(f"{BASE_PATH}/results/maxent_q_table", arr=q_table)
